...
def main():
    global result_csv_path, max_persons_in_window, window_start_time, data_for_3_seconds, zone_coordinates  # Declare result_csv_path as global
    max_persons_in_window = 0
        ...
        def process_frame(frame: np.ndarray, i) -> np.ndarray:
          ...
          if i % frames_per_interval == 0:
            ...
            if elapsed_time >= 3:
              ...
              window_start_time +=3
              # Reset the window variables for the next 3-second window
              #window_start_time += elapsed_time % 3
          ...
          with st.container():
            ...
            try:
                ...
                with st.container():
                  ...
                  col2.write("About the ML Model used for Classification:")
                  col2.write("This is a message or additional information you want to display.")
                  # Create Pyecharts bar chart
                  #crowd_type_counts = result_df['Predicted_Crowd_Type'].value_counts()
